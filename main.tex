...
\scriptsize
\input{math_basics}
\input{nonlinear_optimization}
\input{design_of_experiments}
\input{nonlinear_fea}
\input{meta_modeling_techniques}
\input{shape_topology_optimization}
\input{robustness_sensitivity_analysis}
\input{ml_fundamentals}
\input{generalized_ml_methods}
\input{supervised_unsupervised_learning}
\end{multicols*}
\end{document}
