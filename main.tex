...
%\usepackage{fix-cm}
%\DeclareMathSizes{10}{7}{4}{2}

% https://tex.stackexchange.com/questions/43008/absolute-value-symbols
% but no, we want the shot ones
...
\usepackage{caption}
\DeclareCaptionFont{xxviii}{\fontsize{6}{6}\selectfont}
\captionsetup{font=xxviii}

% define personal alias
\newcommand*{\doubleR}{\ensuremath{\mathbb{R}}}
\newcommand*{\doubleN}{\ensuremath{\mathbb{N}}}
...
\begin{multicols*}{4}
\scriptsize
\input{math_basics.tex}
\input{nonlinear_optimization.tex}
\input{nonlinear_fea.tex}
\input{design_of_experiments.tex}
\input{meta_modeling_techniques.tex}
\input{shape_topology_optimization.tex}
\input{robustness_sensitivity_analysis.tex}
\input{ml_fundamentals.tex}
\input{generalized_ml_methods.tex}
